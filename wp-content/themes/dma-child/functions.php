...
// This is where you run the code and display the output
        ...
        <div class="hidden-xs lien_he">
            ...
            <div class="diachi"><i class="fa fa-home" aria-hidden="true"> </i><ins> Địa chỉ:</ins> <span><?php the_field('dia_chi', 'option'); ?></span></div>
            <?php
            ...
            <div class="website"><i class="fa fa-globe"></i><ins> Website:</ins> <span><?php the_field('websiteurl', 'option'); ?></span></div>
        </div>
        <?php
...
function my_custom_dashboard_widgets() {
    ...
    wp_add_dashboard_widget('custom_help_widget', 'Webwp.vn - Hỗ trợ Khách hàng', 'custom_dashboard_help');
}
function custom_dashboard_help() {
    echo '<p> WebWP.vn | Website - Marketing - Branding</br>
<img src="https://webwp.vn/wp-content/uploads/2019/08/logoWP150.png" class="header_logo header-logo" alt="Thiết kế Website" width="150" height="auto"> </br>
----------------------------</br>
Cảm ơn Quý khách đã sử dụng dịch vụ của Webwp.vn </br>
Mọi thắc mắc xin liên hệ:</br>
Hotline: 0984 688 706 </br>
Website: <a href="https://www.webwp.vn" target="_blank">Webwp.vn</a></br>
Email: <a href="mailto:webwpvn@gmail.com">webwpvn@gmail.com</a>.  
</p>';
}
