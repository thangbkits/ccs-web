...
<?php 
$so_luong = get_field('so-luong');
$noi_lam_viec = get_field('noi_lam_viec');
$luong_td = get_field('luong_td');
$ngay_tuyen = get_field('ngay_tuyen');
$salary = get_field('salary');
?>
<?php if( $so_luong ): ?>
<div class="tuyendung-post">
<h2><span>Số lượng:</span> <b> <?php echo $so_luong; ?></b></h2>
<h2><span>Nơi làm việc:</span> <b> <?php echo $noi_lam_viec; ?></b></h2>
<h2><span>Lương:</span> <b> <?php echo $salary; ?></b></h2>
<h2><span>Ngày tuyển:</span> <b> <?php echo $ngay_tuyen; ?></b></h2>
</div>  
<?php endif; ?>
